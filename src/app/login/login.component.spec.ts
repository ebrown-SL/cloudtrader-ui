...
describe('LoginComponent', () => {
  ...
  it('should not submit the form if username field is empty', () => {
    authServiceStub.login = () => throwError({ error: { message: 'Should not be called' } });
    const loginSpy = spyOn(authServiceStub, 'login');
  ...
  xit('should display an error message if login is unsuccessful', () => {
    authServiceStub.login = () => throwError({ error: { message: 'Error message' } });
  ...
  xit('should navigate to the homepage if login is successful', () => {
    const navigateSpy = spyOn(TestBed.inject(Router), 'navigate');
    authServiceStub.login = () => of(new User());
